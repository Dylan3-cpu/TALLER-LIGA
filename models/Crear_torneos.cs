...
using System.Linq; // Para usar métodos de búsqueda simples
using System.Text;

public class Create // Hacemos la clase pública para poder llamarla desde Program.cs
{
    static List<TournamentModel> tournaments = new List<TournamentModel>();
    // Creamos un método público Mostrar() en vez de Main() para poder llamar desde el main
    ...
    static void AgregarTorneo()
    {
        ...
        tournaments.Add(new TournamentModel(id, nombre));
